class PuppetGem < FPM::Cookery::Recipe
  ...
  platforms [:ubuntu, :debian] do
    def build_files
      system "curl -O https://raw.githubusercontent.com/puppetlabs/puppet/#{version}/ext/debian/puppet.conf"
      system "curl -O https://raw.githubusercontent.com/puppetlabs/puppet/#{version}/ext/debian/puppet.init"
      system "curl -O https://raw.githubusercontent.com/puppetlabs/puppet/#{version}/ext/debian/puppet.default"
  ...
  platforms [:fedora, :redhat, :centos] do
    def build_files
      safesystem "curl -O https://raw.githubusercontent.com/puppetlabs/puppet/#{version}/ext/redhat/puppet.conf"
      safesystem "curl -O https://raw.githubusercontent.com/puppetlabs/puppet/#{version}/ext/redhat/client.init"
      safesystem "curl -O https://raw.githubusercontent.com/puppetlabs/puppet/#{version}/ext/redhat/client.sysconfig"
      # Set the real daemon path in initscript defaults
